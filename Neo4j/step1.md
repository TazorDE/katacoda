...
`docker run -d --log-driver=none --name neo4j -p 7474:7474 -p 7687:7687 -v /csv/netflix_titles.csv:/var/lib/neo4j/import/netflix_titles.csv --env NEO4J_AUTH=neo4j/securepw neo4j:latest`{{execute}}
